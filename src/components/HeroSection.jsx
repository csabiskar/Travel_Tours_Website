...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div className="absolute inset-0 text-white p-6 sm:p-10 md:p-16 lg:px-24 z-10" data-aos="fade-down">
        <div className="flex flex-col items-start justify-center h-full pt-20 sm:pt-28 md:pt-32 lg:pt-40">
          <h2 className="text-base sm:text-lg md:text-xl mb-3 tracking-widest uppercase" >
            Welcome To A  <span className=" bg-gradient-to-r from-[#fa1515] to-[#fa1515] opacity-65">Xplorer</span>
          </h2>
          ...
          {/* CTA Button */}
          <a href="#explore" className="mt-6 bg-white/10 backdrop-blur-md flex justify-center items-center text-white font-semibold py-3 sm:py-4 px-8 sm:px-12 md:px-16 text-base sm:text-lg md:text-xl  shadow-lg hover:bg-white/20 transition-all duration-300">
            Start Exploring
            <GoArrowRight className="ml-2 group-hover:translate-x-2 transition-transform" />
          </a>

          {/* Image cards */}
          <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 w-full" data-aos="fade-down" aos-delay="200">
            {[
              ...
              >
                ...
                />
                <p className="absolute inset-0 flex items-center justify-center text-white text-xl sm:text-2xl font-bold opacity-0 group-hover:opacity-100 group-hover:translate-y-0 translate-y-4 transition-all duration-500">
                  {item.label}
                </p>
              </div>
            ))}
